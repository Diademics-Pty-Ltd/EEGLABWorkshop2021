...
info = StreamInfo('MyMarkerStream', 'Markers', 3, 0, 'float32', 'myuidw43536')
...
while True:
    ...
    markers = [random.random(), random.random(), random.random()]
    outlet.push_sample(markers)
#    outlet.push_sample([random.choice(markernames),random.choice(markernames),random.choice(markernames)])
